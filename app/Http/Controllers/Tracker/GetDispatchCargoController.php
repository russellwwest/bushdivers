...
class GetDispatchCargoController extends Controller
{
    ...
    public function __invoke(Request $request): JsonResponse
    {
        ...
        $cargo = DB::table('pirep_cargos')
            ...
            ->select('contracts.id', 'cargo_type_id as contract_type_id', 'cargo_qty', 'cargo', 'current_airport_id', DB::raw("(CASE WHEN cargo_type_id = '1' THEN 'Cargo' ELSE 'Passengers' END) as contract_type"))
            ->get();
